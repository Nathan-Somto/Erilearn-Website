...
const Courses = (props: Props) => {
  ...
  const scrollToNext = () => {
    ...
    const newScrollPosition =
      scrollPosition + coursesContainerRef.current.clientWidth;
  ...
  return (
    <section className="mb-[100px]">
      ...
      <div className="relative">
        ...
        >
          <button
            className="absolute hidden md:block hover:opacity-50 left-[5px] z-[5] bg-secondary text-white font-bold py-2 px-4 rounded-[6px]"
          ...
          <button
            className="absolute hidden md:block hover:opacity-50 right-[5px] z-[5] bg-secondary text-white font-bold py-2 px-4 rounded-[6px]"
